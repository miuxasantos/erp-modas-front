...
export class ContasPagarComponent implements OnInit {
    private readonly contasPagarApi = inject(ContasPagarApiService);
    private readonly confirmationService = inject(ConfirmationService);
    private readonly messageService = inject(MessageService);
    private readonly fb = inject(FormBuilder);

    contas: ContasPagarResponseDto[] = [];
    ...
    abrirBaixa(conta: ContasPagarResponseDto): void {
    ...
    registrarBaixa(): void {
        ...
        next: () => {
            ...
            detail: `Parcela ${this.contaSelecionada!.numeroParcela}/${this.contaSelecionada!.totalParcelas} paga`,
            });
    ...
    confirmarExclusao(id: number): void {
        ...
        accept: () => {
            this.contasPagarApi.delete(id).subscribe({
            next: () => {
                this.messageService.add({
                severity: 'success',
                summary: 'Sucesso',
